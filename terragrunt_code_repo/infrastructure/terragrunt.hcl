...
locals {
  ...
  helm_directory            = replace("${get_path_to_repo_root()}/helm/charts","//helm/charts", "/helm/charts")
}
  ...
  provider "aws" {
    ...
    default_tags {
      tags = {
        ...
        TerraformRepo = "${local.terraform_repo}"
...
generate "tg_vars" {
  ...
  variable "terraform_repo" {
    type        = string
    description = "The name of the terraform repo"
  }

  variable "terraform_path" {
    type        = string
    description = "Relative path to the terraform directory that deployed this resource"
  }

  variable "helm_directory" {
    type        = string
    description = "Relative path to the helm charts/ configs directory within this terraform repo"
  }
  EOF
}
